...
CREATE TABLE depto
(cod_depto NUMBER(7),
 nome_depto VARCHAR2(25) CONSTRAINT depto_nome_nn NOT NULL,
...
INSERT INTO depto VALUES (22, 'Informatica', 1);
...
INSERT INTO pedido VALUES ( pedido_cod.nextval, current_timestamp - 100,'FONE' , 200, 0, 5, 'O MESMO', 'CTCRED', 200, 8,'EM SEPARACAO');
INSERT INTO pedido VALUES ( pedido_cod.nextval, current_timestamp - 90,'FONE' , 300, 0, 5, 'O MESMO', 'CTCRED', 201, 8,'EM SEPARACAO');
INSERT INTO pedido VALUES ( pedido_cod.nextval, current_timestamp - 80,'FONE' , 400, 0, 5, 'O MESMO', 'CTCRED', 202, 10,'EM SEPARACAO');
...
INSERT INTO pedido VALUES ( pedido_cod.nextval, current_timestamp - 40,'FONE' , 1200, 0, 5, 'O MESMO', 'CTCRED', 201, 11,'EM SEPARACAO');
